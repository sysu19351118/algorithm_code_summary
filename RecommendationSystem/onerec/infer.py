...
def train(config):
    model = OneRec(config, )
    ckpt = torch.load('/home/tangzixuan.8/Generative_recall/generative_recall_rank/compare_exp/onerec/exp/art/dual_tower_model/version_0/checkpoints/epoch-epoch=04.ckpt')
...
if __name__ == "__main__":
    config_file = '/home/tangzixuan.8/Generative_recall/generative_recall_rank/compare_exp/onerec/config/art_onerec.yaml'
